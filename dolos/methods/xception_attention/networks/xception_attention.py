...
def load_xception_attention_model(init):
    model = Xception("reg", None, num_classes=2)
    if init == "imagenet":
        state_dict = torch.load("assets/xception-b5690688.pth")
        ...
        state_dict = torch.load("assets/xcp_reg.tar")
